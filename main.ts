...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.boss, function (sprite, otherSprite) {
    ...
    if (bossDamagable == 1) {
        ...
        bossta.setImage(img`
            ...
            . . . 8 8 8 8 8 8 8 8 8 . . . . 
            . . . 8 8 f 8 8 8 f 8 8 . . . . 
            . . 8 8 f 2 2 8 2 2 f 8 8 . . . 
            . . 8 8 8 2 2 8 2 2 8 8 8 . . . 
            . . 6 8 8 8 8 f 8 8 8 8 6 . . . 
            . . . 8 8 f f 8 f f 8 6 . . . . 
            . . . 6 f f 8 8 8 f f 6 . . . . 
            . . . . 6 6 8 8 8 6 6 . . . . . 
            . . . . . . 6 6 6 . . . . . . . 
...
function spawnFlying (x: number, y: number) {
    flying = sprites.create(img`
        ...
        . . . . . . 6 6 9 6 . . . . . . 
        . . . 6 6 6 9 9 9 9 6 6 6 . . . 
        . . 6 9 9 8 6 6 6 9 9 9 9 6 . . 
        . . 6 9 8 8 8 8 8 6 9 9 9 6 . . 
        . 6 9 8 8 6 8 8 8 8 6 9 9 9 6 . 
        . 6 8 8 6 2 6 8 8 8 6 9 9 9 6 . 
        . 6 8 8 6 2 6 8 8 8 6 9 9 9 6 . 
        . . 6 8 8 6 8 8 8 6 9 9 9 6 . . 
        . . . 6 8 8 8 8 6 9 9 9 6 . . . 
        . . . 6 9 8 6 6 9 9 9 9 6 . . . 
        . . . . 6 6 6 6 6 6 6 6 . . . . 
        . . . . . . . . . . . . . . . . 
